...
function TopBollywood(){
  const [TopbollyData,setTopbollyData]=useState("")
  useEffect(()=>{
    axios("https://node-blog-project-amina.onrender.com/api/new/data")
    .then((res)=>setTopbollyData(res.data))
    .catch((err)=>console.log(err))

  },[])
  // const [Bdata] = useContext(Store);
  // console.log(TopbollyData)
    ...
    return(
        ...
        {TopbollyData && TopbollyData.filter((item) => item.category === 'Bollywood').map((data, index) => {
            return (
